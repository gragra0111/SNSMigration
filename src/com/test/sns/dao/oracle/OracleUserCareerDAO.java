...
public class OracleUserCareerDAO {
	...
	public void insert(OracleUserCareerDTO oracleUserCareerDTO) {
		...
		try {
			...
			ps = conn.prepareStatement("INSERT INTO temp_tb_user_career (USER_ID, SEQ, START_DD, END_DD, CTNT, CREATE_DT, UPDATE_DT) VALUES (?, ?, ?, ?, ?, ?, ?)");
			ps.setString(1, oracleUserCareerDTO.getUser_id());
			ps.setString(2, oracleUserCareerDTO.getSeq());
