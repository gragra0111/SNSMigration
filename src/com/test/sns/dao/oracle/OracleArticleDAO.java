...
public class OracleArticleDAO {
	...
	public void insert(OracleArticleDTO tb_articleDTO) {
		...
		try {
			conn = dataSource.getConnection();
			ps = conn.prepareStatement("INSERT INTO temp_tb_article (ARTICLE_ID, ARTICLE_TYPE, CTNT, CTNT_RAW, DEL_STAT, CREATE_ID, CREATE_DT, UPDATE_ID, UPDATE_DT, TEMP_ARTICLE_ID) VALUES (?, ?, ?, ?, ?, ?, TO_DATE(?,'YYMMDDHHMISS'), ?, TO_DATE(?,'YYMMDDHHMISS'), ?)");
