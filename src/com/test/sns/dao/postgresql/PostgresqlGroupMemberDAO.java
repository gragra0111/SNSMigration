...
public class PostgresqlGroupMemberDAO {
	...
	public void insert(OracleGroupMemberDTO tb_groupMemberDto) {
		...
		try {
			...
			ps = conn.prepareStatement("INSERT INTO temp_tb_group_member (grp_id, mbr_id, mbr_type, create_id, create_dt) VALUES (?, ?, ?, ?, LOCALTIMESTAMP)");
