...
@Service
public class PostgresqlUserLinkDAO {
	@Autowired
	...
	public void insert(OracleUserLinkDTO tb_userLinkDTO) {
		...
		try {
			conn = dataSource.getConnection();
			ps = conn.prepareStatement("INSERT INTO temp_tb_user_link (user_id, seq, link_nm, link_url, create_dt, update_dt) VALUES (?, ?, ?, ?, LOCALTIMESTAMP, LOCALTIMESTAMP)");
